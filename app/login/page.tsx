...
import { ChevronRight, Mail, Lock, ShieldCheck, ArrowRight, Loader2, Sparkles } from "lucide-react";
...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (error === "PendingApproval") {
      setErrorMessage("Your account is awaiting administrative approval.");
        ...
        <div className="space-y-4 text-center">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-black text-white tracking-tight uppercase leading-none">
              {isForgotMode ? "Identity Recovery" : "Node Access"}
            </h1>
            <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em]">
              {isForgotMode 
                ? "Request a secure encryption reset" 
                : "Authorize your design station"}
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-3">
            <div className="flex items-center justify-between px-1">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Global Identifier</label>
            ...
            <div className="space-y-3 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex items-center justify-between px-1">
                ...
                <button 
                  ...
                  className="text-[9px] font-black text-violet-500 hover:text-violet-400 uppercase tracking-tighter"
                >
                  Forgot Key?
                </button>
              </div>
          ...
          >
            ...
            {loading ? (
              ...
              <>
                {isForgotMode ? "Initialize Recovery" : "Authenticate Node"}
            ...
            <>
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                  <span className="bg-[#0a0c14] px-4 text-slate-500 font-black">Secure OAuth Gateway</span>
                </div>
              </div>
          ...
          {isForgotMode && (
            <button
              ...
              className="w-full text-[9px] font-black text-slate-500 hover:text-white transition-colors uppercase tracking-[0.2em]"
            >
        ...
        {!isForgotMode && (
          <div className="pt-6 border-t border-white/5 text-center">
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">
              No registry account? <Link href="/register" className="text-white hover:text-violet-400 font-black ml-1 transition-colors underline underline-offset-4 decoration-white/20">Initialize Identity</Link>
            </p>
          </div>
        )}
...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#02040a] p-6 selection:bg-violet-500/30">
      ...
      <Suspense fallback={
        <div className="w-full max-w-[460px] h-[600px] rounded-[2.5rem] bg-white/[0.02] border border-white/5 animate-pulse flex items-center justify-center">
      ...
      <footer className="fixed bottom-8 text-center space-y-2 pointer-events-none opacity-30">
        <p className="text-[9px] font-black text-slate-600 uppercase tracking-[0.5em]">CertGen Operations Studio © 2026</p>
